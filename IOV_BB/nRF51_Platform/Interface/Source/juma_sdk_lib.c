...
inline int8_t I2C_bus_write(uint8_t dev_addr, uint8_t reg_addr, uint8_t * reg_data, uint8_t cnt)
{
	return sys->I2C_bus_write(dev_addr, reg_addr, reg_data, cnt);
}
inline int8_t I2C_bus_write_byte(uint8_t dev_addr, uint8_t reg_addr, uint8_t value)
{
	return sys->I2C_bus_write_byte(dev_addr, reg_addr, value);
}
inline int8_t I2C_bus_read(uint8_t dev_addr, uint8_t reg_addr, uint8_t * reg_data, uint8_t cnt)
{
	return sys->I2C_bus_read(dev_addr, reg_addr, reg_data, cnt);
}
inline uint8_t I2C_bus_read_byte(uint8_t dev_addr, uint8_t reg_addr)
{
