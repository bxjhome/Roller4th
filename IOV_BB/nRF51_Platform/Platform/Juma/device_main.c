...
static void app_error_handler_juma(uint32_t error_code, uint32_t line_num, const uint8_t * p_file_name)
{
    nrf_delay_ms(100);
...
{
    app_error_handler_juma(DEAD_BEEF, line_num, p_file_name);
}
